    ...
    <section id="about" className="py-8">
      ...
      <div className="mt-4 text-lg leading-relaxed">
        <p>
          ...
          <a href="https://xuminghu.github.io/" className="text-blue-600 hover:underline">Prof. Xuming HU</a>. Currently, I am a visiting student at NYU Center for Data Science, working with {' '}
