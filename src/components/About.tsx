...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-8">
      ...
      <div ref={containerRef} className="mt-4 font-serif text-lg leading-relaxed space-y-4 text-ink-2 dark:text-[#D5D0C6]">
        ...
        <motion.p
          ...
          className="mt-4 text-accent dark:text-[#D4847C] font-medium px-4 py-3 border border-accent/20 dark:border-[#D4847C]/30 bg-accent-soft dark:bg-[#D4847C]/12"
        >
          <motion.span
