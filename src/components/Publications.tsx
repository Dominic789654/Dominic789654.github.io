...
export const Publications: React.FC = () => {
  ...
  const selectedPublications = [
    ...
    },
    {
      ...
      venue:
        "NeurIPS 2025 Multi-Turn Interactions in Large Language Models Workshop",
      links: {
  ...
  const preprints = [
    {
      ...
      links: {
        paper: "https://arxiv.org/abs/2602.04914",
      },
    },
    {
      id: 37,
  ...
  const fullPublications = [
    ...
    },
    {
      ...
      links: {
        paper:
          "https://proceedings.neurips.cc/paper_files/paper/2024/file/ff997469ac66cf893c4183efeb22212a-Paper-Conference.pdf",
      },
    },
    {
      id: 29,
  ...
  const conferenceCounts = [...fullPublications].reduce(
    (acc, pub) => {
