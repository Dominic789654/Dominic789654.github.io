  ...
  const services = [
    {
      ...
      items: "ICLR 2025-2026, ICML 2025-2026, ACL 2024-2026, NeurIPS 2024-2026, EMNLP 2023-2026, COLM 2026, AAAI 2026"
    },
    {
      id: 2,
        ...
        {services.map((service, idx) => (
          ...
          >
            <motion.div
              ...
              className="text-accent dark:text-[#E89B7A] flex-shrink-0"
            >
            ...
            <div className="flex-1">
              <motion.h3
                ...
                className="text-lg font-semibold text-ink dark:text-[#E8E4DC] group-hover:text-accent dark:group-hover:text-[#E89B7A] transition-colors"
              >
                {service.title}
              </motion.h3>
              <motion.p
